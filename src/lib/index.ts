...
async function signTransactionWarp(
  params: Types.SignTransactionWarpProps
): Promise<Types.SignTransactionWarpReturnProps> {
  params.tags ??= [];
...
async function signTransactionArweave(
  params: Types.SignTransactionArweaveProps
): Promise<Types.SignTransactionArweaveReturnProps> {
  params.tags ??= [];
...
async function sendTransactionArweave(
  params: Types.SendTransactionArweaveProps
): Promise<Types.SendTransactionArweaveReturnProps> {
...
async function sendTransactionWarp(
  params: Types.SendTransactionWarpProps
): Promise<Types.SendTransactionWarpReturnProps> {
...
async function initializeJWK(
  params: Types.InitializeJWKProps
): Promise<Types.InitializeJWKReturnProps> {
  const auth0Client = await createAuth0Client({
    domain: "othent.us.auth0.com",
    clientId: "dyegx4dZj5yOv0v0RkoUsc48CIqaNS6C",
  });
    ...
    authorizationParams: {
      transaction_input: JSON.stringify({
        ...
        warpData: {
          ...
          data: { JWK_public_key: params.JWK_public_key },
        },
      }),
    },
  };
...
async function JWKBackupTxn(
  params: Types.JWKBackupTxnProps
): Promise<Types.JWKBackupTxnReturnProps> {
  return await axios({
    method: "POST",
